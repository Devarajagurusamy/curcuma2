...
export default function PricingSection() {
  ...
  const handleAddToCart = (id: string) => {
    setAddedCard(id);
    setTimeout(() => setAddedCard(null), 2000);
  };

  return (
    <section id="order" className="w-full py-16 sm:py-20 bg-[#FAF7F2] border-t border-[#ede3d5] relative overflow-hidden">
      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-8 xl:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 xl:gap-7 items-stretch">
          ...
          {/* Column 1: Choose Your Healing Routine & Guarantees (2.5 cols on desktop) */}
          <div className="lg:col-span-3 flex flex-col justify-between p-2 sm:p-4 space-y-6">
            ...
            <div>
              ...
              {/* Guarantees List */}
              <div className="space-y-3.5 mt-6 sm:mt-8">
            ...
            <div className="grid grid-cols-3 gap-2 pt-6 border-t border-[#e8ded0] text-center">
          ...
          <div className="lg:col-span-2 bg-[#FAF7F2] rounded-2xl border border-[#ede1d3] p-5 sm:p-6 shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex flex-col justify-between text-center hover:shadow-[0_8px_30px_rgba(0,0,0,0.07)] transition-all">
            ...
            {/* Header */}
            <div>
              <h3 className="font-serif text-xl font-bold text-[#142319]">
                1 BOTTLE
              </h3>
            ...
            <div className="my-5 w-full flex items-center justify-center">
              <div className="w-36 h-36 sm:w-40 sm:h-40 rounded-xl overflow-hidden mix-blend-multiply flex items-center justify-center">
                <img
            ...
            <div className="space-y-3">
              ...
              {/* Add to Cart Button */}
              <button
                onClick={() => handleAddToCart("1-bottle")}
              ...
              >
                ...
                <span>{addedCard === "1-bottle" ? "ADDED ✓" : "ADD TO CART"}</span>
              </button>
            </div>
          ...
          <div className="lg:col-span-3 bg-[#FAF7F2] rounded-2xl border-2 border-[#c58b28] shadow-[0_8px_32px_rgba(197,139,40,0.18)] flex flex-col justify-between text-center relative hover:shadow-[0_12px_40px_rgba(197,139,40,0.25)] transition-all lg:-translate-y-2">
            ...
            <div className="p-5 sm:p-6 flex flex-col justify-between flex-1">
              {/* Header */}
              <div>
                <h3 className="font-serif text-2xl font-extrabold text-[#142319]">
                  3 BOTTLES
                </h3>
                <p className="text-xs text-[#637067] font-medium mt-0.5">
                  180 Capsules
              ...
              <div className="my-4 w-full flex items-center justify-center">
                <div className="w-44 h-44 sm:w-48 sm:h-48 rounded-xl overflow-hidden mix-blend-multiply flex items-center justify-center">
                  <img
              ...
              <div className="space-y-3">
                <div className="flex items-baseline justify-center gap-2">
                  <span className="text-xs font-bold text-[#142319]">RM</span>
                  <span className="text-3xl font-black text-[#142319] tracking-tight">399.90</span>
                ...
                {/* Add to Cart Button */}
                <button
                  onClick={() => handleAddToCart("3-bottles")}
                ...
                >
                  ...
                  <span>{addedCard === "3-bottles" ? "ADDED TO CART ✓" : "ADD TO CART"}</span>
                </button>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 bg-[#FAF7F2] rounded-2xl border border-[#ede1d3] p-5 sm:p-6 shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex flex-col justify-between text-center hover:shadow-[0_8px_30px_rgba(0,0,0,0.07)] transition-all">
            ...
            <div className="space-y-3">
              ...
              {/* Add to Cart Button */}
              <button
                onClick={() => handleAddToCart("2-bottles")}
                className="w-full py-3 rounded-xl bg-[#c58b28] hover:bg-[#b0781e] text-white text-xs font-extrabold tracking-[0.08em] uppercase shadow-md hover:shadow-lg transition-all cursor-pointer flex items-center justify-center gap-2 active:scale-98"
              >
                <ShoppingCart className="w-3.5 h-3.5" />
                <span>{addedCard === "2-bottles" ? "ADDED ✓" : "ADD TO CART"}</span>
              </button>
            </div>

          </div>

          {/* Column 5: Recommended Dosage & Precaution Guide Card (2 cols on desktop) */}
          <div className="lg:col-span-2 bg-[#FAF6EE] rounded-2xl border border-[#ede1d3] p-5 sm:p-6 shadow-sm flex flex-col justify-between space-y-6">
            ...
            <div className="pt-4 border-t border-[#e8ded0]">
              ...
              <p className="text-[11px] sm:text-xs text-[#5c6861] leading-relaxed mt-2 font-normal">
