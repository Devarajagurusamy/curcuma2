...
export const translations: Record<"en" | "bm", TranslationType> = {
  en: {
      ...
      steps: [
        {
          ...
          description: "Tuan Ismail brought pure black turmeric to his family, searching for a natural way to relieve deep fatigue, ease body aches, and restore strength.",
    ...
    footer: {
      ...
      companyTitle: "MALAYSIAN ROYAL GOLD",
      companySub: "By Berkat Curcuma Caesia Sdn Bhd",
      companyAddress: "Plot 1, Kampung Seri Aman, Jalan Kulai Kota Tinggi, 81900 Kota Tinggi, Johor, Malaysia.",
      colExplore: "EXPLORE",
      colHelp: "HELP & CARE",
      ...
      rights: "© 2026 Berkat Curcuma Caesia Sdn Bhd. All rights reserved.",
      links: {
  ...
  bm: {
      ...
      steps: [
        {
          ...
          description: "Tuan Ismail membawa kunyit hitam tulen untuk keluarganya bagi melegakan keletihan kronik, sengal badan, dan mengembalikan tenaga fizikal.",
          imageAlt: "Pengasas Tuan Ismail di ladang kunyit hitam",
        },
        {
          step: "02",
    ...
    footer: {
      ...
      companyTitle: "MALAYSIAN ROYAL GOLD",
      companySub: "Oleh Berkat Curcuma Caesia Sdn Bhd",
      companyAddress: "Plot 1, Kampung Seri Aman, Jalan Kulai Kota Tinggi, 81900 Kota Tinggi, Johor, Malaysia.",
      colExplore: "TEROKAI",
      ...
      rights: "© 2026 Berkat Curcuma Caesia Sdn Bhd. Hak cipta terpelihara.",
      links: {
